      ...
      <div className="container_center w-[90%] h-full mx-auto flex items-center text-white relative z-10">
        <div className="left_container w-[40%]">
          ...
          <p className="text-md">
            ...
            architecto exercitationem ea! Doloremque qui, laborum dolorem minima
            ut et accusamus vero labore quasi animi error nemo possimus id,
            omnis impedit, provident assumenda nostrum reiciendis ipsum placeat
            velit cum. Nostrum corrupti illo at?
          </p>
          <div className="flex gap-2 my-5">
            <p>2hr:55mins</p>
            <p></p>
