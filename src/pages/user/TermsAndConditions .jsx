...
const TermsAndConditions = () => {
  return (
    <div className=" mx-auto px-15 py-10 text-gray-800 space-y-6 ">
      <h1 className="text-2xl font-bold text-center">Terms and Conditions</h1>
      <div className="space-y-4 text-justify">
        <p className="font-bold">Introduction</p>
        <p>
          Welcome to Chitramcinema ("Company", "we", "our", "us")! These Terms
          of Service ("Terms", "Terms of Service") govern your use of our
          website located at chitramcinema@gmail.com (together or individually
          "Service") operated by Chitramcinema.
        </p>
        <p>
        ...
        <p>
          ...
          chitramcinema@gmail.com so we can try to find a solution. These Terms
        ...
        <p className="font-bold">Contests, Sweepstakes and Promotions</p>
        <p>
        ...
        <p>
          ...
          Chitramcinema or used with permission. You may not distribute, modify,
          ...
          without express advance written permission from us. You may use
          Service only for lawful purposes and in accordance with Terms. You
          agree not to use Service: In any way that violates any applicable
        ...
        <p>
          Additionally, you agree not to use Service in any manner that could
          disable, overburden, damage, or impair Service or interfere with any
          other party’s use of Service, including their ability to engage in
          real time activities through Service. Use any robot, spider, or other
        ...
        <p>
          ...
          or any server, computer, or database connected to Service. Attack
        ...
        <p>
          ...
          use of our Service. Minors Service is intended only for access and use
          by individuals at least eighteen (18) years old. By accessing or using
          Service, you warrant and represent that you are at least eighteen (18)
        ...
        <p>
          ...
          property of Chitramcinema and its licensors. Service is protected by
          ...
          without the prior written consent of Chitramcinema works.
        </p>
        ...
        <p>
          ...
          to chitramcinema@gmail.com, with the subject line: "Copyright
        ...
        <p>
          DMCA Notice and Procedure for You may submit a notification pursuant
          ...
          U.S.C 512(c) (3) for further detail): an electronic or physical
          signature of the person authorized to act on behalf of the owner of
          the copyright’s interest;a description of the copyrighted work that
          you claim has been infringed, including the URL (i.e., web page
          address) of the location where the copyrighted work exists or a copy
          of the copyrighted work; Identification of the URL or other specific
          location on Service where the material that you claim is infringing is
          located; your address, telephone number, and email address; a
          ...
          contact our Copyright Agent via email at chitramcinema@gmail.com
        </p>
        <p>
          You may provide us either directly at chitramcinema@gmail.com or via
        ...
        <p className="font-bold">Web Sites</p>
        <p>
          Our Service may contain links to third party web sites or services
          that are not owned or controlled by Chitramcinema. Chitramcinema has
        ...
        <p>
          ...
          expressly agree that you’re use of these services, their content, and
        ...
        <p>
          ...
          or limited under applicable law of liability Except as prohibited by
          law, you will hold us and our officers, directors, employees, and
          ...
          trial or on appeal, if any, whether or not litigation or arbitration
        ...
        <p className="font-bold">Governing Law, Jurisdiction</p>
        <p>
          These Terms shall be governed and construed in accordance with the
          laws of India, which governing law applies to agreement without regard
          to its conflict of law provisions. The place of jurisdiction will be
          Hyderabad.
        </p>
        <p>
        ...
        <p>
          ...
          support by email: chitramcinema@gmail.com.
        </p>
      </div>
    </div>
  );
