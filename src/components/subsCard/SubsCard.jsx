...
const SubsCard = ({
  ...
  return (
    <div className="flex justify-center items-center ">
      <div className="w-50 rounded-2xl  p-5 md:h-80 md:w-70 cursor-pointer hover:shadow-lg hover:scale-105 transition-transform duration-300 bg-white/10 backdrop-blur-md shadow-[0_8px_32px_0_rgba(31,38,135,0.2)] border border-white/30 hover:brightness-110  flex-col text-xs text-white">
        {/* Plan Header */}
